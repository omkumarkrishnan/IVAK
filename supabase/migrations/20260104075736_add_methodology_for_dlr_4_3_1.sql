/*
  # Add Verification Methodology for DLR 4.3.1
  
  1. Purpose
    - Add comprehensive verification methodology for DLR 4.3.1 (Three new NSQF compliant training programs conducted by SICB/SDD in priority sectors)
  ...
  3. Changes
    - Update methodology field for all verifications under DLR 4.3.1
*/

-- Update methodology for DLR 4.3.1 verifications
...
WHERE dli_id = (SELECT id FROM dlis WHERE code = 'DLR 4.3.1');

/*
  # Add Verification Methodology for DLR 5.4.1
  
  1. Purpose
    - Add comprehensive verification methodology for DLR 5.4.1 (50 percent financing disbursed in each district as per the district-level IEIAPs - cumulative)
  ...
  3. Changes
    - Update methodology field for all verifications under DLR 5.4.1
*/

-- Update methodology for DLR 5.4.1 verifications
...
WHERE dli_id = (SELECT id FROM dlis WHERE code = 'DLR 5.4.1');
